// 問題 9.4 ★が回転しながら水平方向に等速直線運動し壁で反射するアニメーションをクラスを用いて作成せよ．
// ただし，フィールドとして★の色 c，★の外接円の直径 d，位置 x, y，水平方向の速度 vx，回転速度 theta を持ち，
...
void setup(){
  ...
  */
  rs = new Star(0, 0, 1, 0, 0, 0, 128, width, height, 40, 40, 40/2*0.75, 5, PI/2, 0.75);
}

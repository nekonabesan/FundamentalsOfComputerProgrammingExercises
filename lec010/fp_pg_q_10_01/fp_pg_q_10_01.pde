...
void setup(){
  ...
  float cc = 50;
  float rotate = -PI/2;
  pt = new Pentagon(x, y, vx, vy, r, g, b, width, height, d, cc, 5, rotate, 0.75);
}
...
class Pentagon extends Ball {
  Pentagon(float x, float y, float vx, float vy,
    float r, float g, float b, float w, float h,
    float d, float circumscribedCircle,
    int p, float rotate, float rate){
    super(x, y, vx, vy, r, g, b, w, h, d,
